...
public class AlloyFurnaceRecipe implements Recipe<SimpleContainer> {
    ...
    private final NonNullList<IngredientWithCount> inputItems;
    private final FluidStack fluidStack;
    private final int processingTime;

    public AlloyFurnaceRecipe(ResourceLocation id, ItemStack output,
                              NonNullList<IngredientWithCount> inputItems, FluidStack fluidStack, int processingTime) {
        this.id = id;
        this.result = output;
    ...
    public boolean matches(SimpleContainer pContainer, Level pLevel) {
        ...
        List<IngredientWithCount> remainingIngredients = new ArrayList<>(inputItems);
    ...
    public NonNullList<IngredientWithCount> getInputItems() {
        return inputItems;
    }
    ...
    public NonNullList<Ingredient> getIngredients() {
        ...
        for (IngredientWithCount ing : inputItems) {
    ...
    public static class Serializer implements RecipeSerializer<AlloyFurnaceRecipe> {
        ...
        public void toNetwork(FriendlyByteBuf buf, AlloyFurnaceRecipe recipe) {
            ...
            for (IngredientWithCount ing : recipe.inputItems) {
