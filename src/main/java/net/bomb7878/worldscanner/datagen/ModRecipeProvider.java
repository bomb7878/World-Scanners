...
import net.bomb7878.worldscanner.recipe.builders.AdvancedAlloyingRecipeBuilder;
...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        createAdvancedAlloyingRecipe(ModItems.BRONZE_INGOT, 4, Fluids.LAVA,100 , 280,
                Items.COPPER_INGOT, 3, ModItems.TIN_INGOT.get(), 1, consumer);
        createAdvancedAlloyingRecipe(ModItems.BRONZE_INGOT, 4, ModFluids.MOLTEN_SOULS.get(),100 , 320,
                Items.COPPER_INGOT, 3, ModItems.TIN_INGOT.get(), 1, consumer);

        createAdvancedAlloyingRecipe(ModItems.STEEL_INGOT, 1, Fluids.LAVA,250, 320,
                Items.IRON_INGOT, 1, Items.COAL, 4, consumer);
        createAdvancedAlloyingRecipe(ModItems.STEEL_INGOT, 1, ModFluids.MOLTEN_SOULS.get(),250, 320,
                Items.IRON_INGOT, 1, Items.COAL, 4, consumer);

        createAdvancedAlloyingRecipe(ModItems.DARK_STEEL_INGOT, 8, Fluids.LAVA,350, 520,
                ModItems.STEEL_INGOT.get(), 8, ModItems.ANCIENT_DARK_CRYSTAL.get(), 1, consumer);
        createAdvancedAlloyingRecipe(ModItems.DARK_STEEL_INGOT, 8, ModFluids.MOLTEN_SOULS.get(),350, 560,
                ModItems.STEEL_INGOT.get(), 8, ModItems.ANCIENT_DARK_CRYSTAL.get(), 1, consumer);

        createAdvancedAlloyingRecipe(ModItems.ENDER_STEEL_NUGGET, 3, Fluids.LAVA,500, 360,
                ModItems.DARK_STEEL_INGOT.get(), 1, Items.ENDER_EYE, 1, consumer);
        createAdvancedAlloyingRecipe(ModItems.ENDER_STEEL_NUGGET, 3, ModFluids.MOLTEN_SOULS.get(),500, 400,
                ModItems.DARK_STEEL_INGOT.get(), 1, Items.ENDER_EYE, 1, consumer);

        createAdvancedAlloyingRecipe(ModItems.BLOCK_OF_BRONZE, 4, Fluids.LAVA,750, 1520,
                Items.COPPER_BLOCK, 3, ModItems.BLOCK_OF_TIN.get(), 1, consumer);
        createAdvancedAlloyingRecipe(ModItems.BLOCK_OF_BRONZE, 4, ModFluids.MOLTEN_SOULS.get(),750, 1520,
                Items.COPPER_BLOCK, 3, ModItems.BLOCK_OF_TIN.get(), 1, consumer);

        createAdvancedAlloyingRecipe(ModItems.BLOCK_OF_STEEL, 1, Fluids.LAVA,1000, 2000,
                Items.IRON_BLOCK, 1, Items.COAL_BLOCK, 4, consumer);
        createAdvancedAlloyingRecipe(ModItems.BLOCK_OF_STEEL, 1, ModFluids.MOLTEN_SOULS.get(),1000, 2000,
                Items.IRON_BLOCK, 1, Items.COAL_BLOCK, 4, consumer);

        createAdvancedAlloyingRecipe(ModItems.ENDER_STEEL_INGOT, 3, Fluids.LAVA,1500, 2400,
                ModItems.BLOCK_OF_DARK_STEEL.get(), 1, Items.ENDER_EYE, 9, consumer);
        createAdvancedAlloyingRecipe(ModItems.ENDER_STEEL_INGOT, 3, ModFluids.MOLTEN_SOULS.get(),1500, 2400,
                ModItems.BLOCK_OF_DARK_STEEL.get(), 1, Items.ENDER_EYE, 9, consumer);
    }
    ...
    protected static void createAdvancedAlloyingRecipe(RegistryObject<Item> resultItem, int resultItemCount, Fluid fluid, int fluidAmount, int processingTime, Item firstItem, int firstItemCount, Item secondItem, int secondItemCount, Consumer<FinishedRecipe> consumer) {
        AdvancedAlloyingRecipeBuilder.advancedAlloying(
                        new ItemStack(resultItem.get(), resultItemCount),
                        List.of(
                                new FluidStack(fluid, fluidAmount)
                        ),
                        fluid.getFluidType().getTemperature() > 1300 ? processingTime / 2: processingTime
                )
                .requires(Ingredient.of(firstItem), firstItemCount)
                .requires(Ingredient.of(secondItem), secondItemCount)
                .unlockedBy("has_" + firstItem.getDescriptionId(), has(firstItem))
                .unlockedBy("has_" + secondItem.getDescriptionId(), has(secondItem))
                .save(consumer, new ResourceLocation(WorldScanner.MOD_ID, getItemName(resultItem.get()) +
                        "_from_advanced_alloying_with_" + fluid.getFluidType().toString()
                        .replace(":", "")
                        .replace("minecraft", "")
                        .replace(WorldScanner.MOD_ID, ""))
                );
    }
}
