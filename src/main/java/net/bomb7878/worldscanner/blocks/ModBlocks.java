...
import net.bomb7878.worldscanner.fluid.block.BurningLiquidBlock;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> ADVANCED_ALLOY_FURNACE = BLOCKS.register(
            "advanced_alloy_furnace", AdvancedAlloyFurnaceBlock::new
    );
    ...
    public static final RegistryObject<LiquidBlock> MOLTEN_SOULS_BLOCK = BLOCKS.register("molten_souls_block",
            () -> BurningLiquidBlock.createBurning(
                    15,
                    5,
                    3.0F
            ).apply(ModFluids.MOLTEN_SOULS)
    );
}
