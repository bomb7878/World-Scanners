...
public class ModItems {
    ...
    public static final RegistryObject<Item> ADVANCED_ALLOY_FURNACE = ITEMS.register("advanced_alloy_furnace",
            () -> new BlockItem(ModBlocks.ADVANCED_ALLOY_FURNACE.get(), new Item.Properties()
                    .rarity(Rarity.EPIC)
                    .fireResistant()
            ));
    ...
    public static final RegistryObject<Item> MOLTEN_SOULS_BUCKET = ITEMS.register("molten_souls_bucket",
            () -> new BucketItem(ModFluids.MOLTEN_SOULS, new Item.Properties()
                    .stacksTo(1)
