...
public class AdvancedAlloyFurnaceScreen extends AbstractContainerScreen<AdvancedAlloyFurnaceMenu> {
    ...
    public AdvancedAlloyFurnaceScreen(AdvancedAlloyFurnaceMenu menu, Inventory inventory, Component component) {
    ...
    private void assignFluidRenderer() {
        renderer = new FluidTankRenderer(16000, true, 10, 55);
    }
    ...
    protected void renderLabels(PoseStack pPoseStack, int pMouseX, int pMouseY) {
        ...
        this.font.draw(pPoseStack,
                Component.translatable("block.worldscanner.advanced_alloy_furnace"),
                8, 6, titleColor);
