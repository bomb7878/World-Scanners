...
import net.bomb7878.worldscanner.fluid.ModFluidTypes;
...
import net.bomb7878.worldscanner.screen.items.ScannerScreen;
...
public class WorldScanner {
    ...
    private void addCreative(final CreativeModeTabEvent.BuildContents event) {
        if (event.getTab() == ModCreativeTabs.tab) {
            ...
            event.accept(ModItems.ADVANCED_ALLOY_FURNACE);
            event.accept(ModItems.MOLTEN_SOULS_BUCKET);
    ...
    public static class ClientModEvents {
        ...
        public static void onClientSetup(FMLClientSetupEvent event) {
            ItemBlockRenderTypes.setRenderLayer(ModFluids.MOLTEN_SOULS.get(), RenderType.solid());
            ItemBlockRenderTypes.setRenderLayer(ModFluids.FLOWING_MOLTEN_SOULS.get(), RenderType.solid());
